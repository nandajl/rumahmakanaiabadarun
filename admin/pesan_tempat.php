  ...
  <div class="row">
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
        <form class="row g-3" action="" method="post">
          ...
          if (isset($_POST['submit'])){
            include 'koneksi.php';
            $q = mysqli_query($kon,"INSERT INTO pesan_tempat(id_pesan, id_menu, id_pelanggan, jumlah_pesan, status_bayar) VALUES(null, '$_POST[id_menu]','$_GET[id_pelanggan]','$_POST[jumlah_pesan]','belum bayar')");
      ...
      <div class="container">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            $no=1;
            $tampil=mysqli_query($kon,"SELECT * FROM menu JOIN pesan_tempat USING(id_menu) JOIN pelanggan USING(id_pelanggan) WHERE id_pelanggan='$_GET[id_pelanggan]' and status_bayar='belum bayar';");
            while ($data=mysqli_fetch_array($tampil)) {
              ...
              <tr>
                ...
                <td><a href="aksi/aksi_pesan_tempat.php?page=pesan_tempat&proses=hapus&id=<?php echo $data['id_pesan']; ?>" onclick="return confirm('Yakin akan menghapus data ?');" class="btn btn-danger btn-sm">Hapus </a> |
                  <a href="index.php?p=bayar_tempat&id_pesan=<?php echo $data['id_pesan']; ?>" class="btn btn-success btn-sm">Bayar</a></td>
                </tr>
                <?php
                $no++;
              }
      ...
      case 'edit':
        ...
        include '../koneksi.php';
        $ambil=mysqli_query($kon,"SELECT * FROM pesan WHERE id_pesan='$_GET[id]'");
        $data=mysqli_fetch_array($ambil);
        ?>
      ...
      <div class="container">
        <form class="row g-3" action="aksi/aksi_pesan_tempat.php?page=pesan_tempat&proses=update" method="post">
          <div class="row mb-3">
            <label class="label-control">Nama Pelanggan</label>
            <div class="col-sm-10">
