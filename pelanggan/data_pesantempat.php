		...
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				<div class="btn-group me-2">
					<a href=?p=data_pesantempat&aksi=print>
		...
		<div class="container">
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					$no=1;
					$tampil=mysqli_query($kon,"SELECT * FROM menu,pelanggan,pesan_tempat WHERE menu.id_menu=pesan_tempat.id_menu and pelanggan.id_pelanggan=pesan_tempat.id_pelanggan");
					while ($data=mysqli_fetch_array($tampil)) {
						...
						<tr>
							...
							<td><a href=?p=data_pesantempat&aksi=edit&id=<?php echo $data['id_pesan']; ?> class="btn btn-primary btn-sm">Ubah</a> |
								<a href="aksi/aksi_data_pesantempat.php?page=data_pesantempat&proses=hapus&id=<?php echo $data['id_pesan']; ?>" onclick="return confirm('Yakin akan menghapus data ?');" class="btn btn-danger btn-sm">Hapus</td> </a>
							</tr>
							<?php
							$no++;
						}
			...
			break;
			case 'edit':
			$ambil=mysqli_query($kon,"SELECT * FROM pelanggan join pesan_tempat using(id_pelanggan) join menu using(id_menu) WHERE id_pesan=$_GET[id]");
			$data=mysqli_fetch_array($ambil);

			?>
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
					<h1 class="h2">Edit Data Pesan tempat</h1>

				</div>
				<div class="container">


					<form class="row g-3" action="aksi/aksi_data_pesantempat.php?page=data_pesantempat&proses=update" method="post">
						<div class="row mb-3">
